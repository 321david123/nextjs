        ...
        <div className="nav-container">
          ...
          <nav role="navigation" className="nav-menu w-nav-menu">
            <a href="" className="nav-link w-nav-link">
              <button className='nav-link w-nav-link' style={{padding: '0'}} onClick={handleLoginClick}>Modelos</button>
            </a>
          ...
          >
            ...
            >
              <div className="cell-content link">
                ...
                //   srcSe  t="https://ruedatec.com/images/Cell-Background-1_1-p-500.jpg 500w, https://ruedatec.com/images/Cell-Background-1_1-p-800.jpg 800w, https://ruedatec.com/images/Cell-Background-1_1-p-1080.jpg 1080w, https://ruedatec.com/images/Cell-Background-1_1-p-1600.jpg 1600w, https://ruedatec.com/images/Cell-Background-1_1-p-2000.jpg 2000w, https://ruedatec.com/images/Cell-Background-1_1-p-2600.jpg 2600w, https://ruedatec.com/images/Cell-Background-1_1-p-3200.jpg 3200w"
                  alt=""
                  className="background-image"
                />
                <h3 className="heading-4">
                  RuedaTec, una nueva perspectiva de movilidad. Con energía solar
                  y diseño ergonómico, llevamos la comodidad y eficiencia a otro
                  nivel.
                </h3>
              </div>
            </div>
            ...
            >
              <div className="cell-content link">
                ...
                <div className="w-layout-hflex bottom-content-wrapper">
                  <h3 className="bottom-heading">Mantente al tanto del avance</h3>
                </div>
                <img
          ...
          >
            ...
            >
              ...
              <div className="text-small max-width-35ch">
                Realizamos un diseño 3D antes que nada en la aplicacion de blender
                para poder darnos una idea sobre lo que podiamos lograr y tener un
                buen inicio para la construccion
              </div>
            </div>
            <div
            ...
            >
              ...
              <h3>La app.</h3>
              <div className="text-small max-width-35ch">
                La aplicación de RuedaTec, esta siendo creada con la tecnología de
                Flutter, es la clave para interactuar con tu silla de ruedas de
                manera inteligente. Controla la velocidad, dirección y funciones
                especiales con tan solo deslizar tu dedo. Diseñada para brindar
                una experiencia intuitiva y personalizable, la aplicación Flutter
                te permitirá vivir la movilidad en su máxima expresión. Descubre
                el futuro de la movilidad con la app de &nbsp;RuedaTec en tus
                manos.
              </div>
            </div>
          </div>
